...
- *2023.03 – 2024.07*, Intern, **Tencent Big Data**. Led the development of [TenANN](https://github.com/StarRocks/tenann) and contributed [vector search capabilities](https://github.com/StarRocks/starrocks/issues/46678) to StarRocks, a leading open-source OLAP database widely used by Airbnb, Alibaba, Tencent, and Xiaohongshu.
